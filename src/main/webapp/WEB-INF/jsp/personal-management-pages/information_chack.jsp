...
<form class="layui-form" action="">
	    ...
	    <label class="layui-form-label_3" name="iusername" id="iusername" >${list[0].iusername}</label>      
         ...
         <c:if test="${list[0].isex == 0}">
         <label class="layui-form-label_3" name="isex" id="isex" >男</label>
         </c:if>
         <c:if test="${list[0].isex == 1}">
         <label class="layui-form-label_3" name="isex" id="isex" >女</label>
         </c:if>   
	    ...
	    <label class="layui-form-label_3" name="iprofession" id="iprofession" >${list[0].iprofession}</label>  
         ...
         <label class="layui-form-label_3" name="istatus" id="istatus" >在职中</label> 
         </c:if>
         <c:if test="${list[0].istatus == 1}">
         <label class="layui-form-label_3" name="istatus" id="istatus" >待定中</label> 
         </c:if>  
	    </div>
    	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    		  <legend>简历信息</legend>
